...
| Commercial      | billing/source profile, quotation, contract reference, acceptance certificate, payment, expense, immutable document | tax, ledger accounts, refunds, e-signature, gateway settlement     | each mutation, generated snapshot and audit commit atomically; totals are exact live projections |
