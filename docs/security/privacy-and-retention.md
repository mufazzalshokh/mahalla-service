...
| Quote/contract/payment references     | operate a manually approved commercial service     | commercial records          | provisional 7 years only if finance/legal approves; synthetic pilot data otherwise  |
| Generated commercial text/checksum    | reproduce what staff shared and detect alteration  | immutable document snapshot | follows the linked commercial record; deletion requires an approved archival policy |
...
Commercial audit stores codes, classifications, dates and amount strings, not generated document
bodies, contract summaries, payment-proof text or resident PII. Until OQ-009 is approved, CP-09
commercial records must remain synthetic and cannot be treated as fiscal, signed or accounting
evidence.
